...
/* package pandoc-filter-0.1.0.0 */
#ifndef VERSION_pandoc_filter
#define VERSION_pandoc_filter "0.1.0.0"
#endif /* VERSION_pandoc_filter */
#ifndef MIN_VERSION_pandoc_filter
#define MIN_VERSION_pandoc_filter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pandoc_filter */
...
#define CURRENT_PACKAGE_KEY "pandoc-filter-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "pandoc-filter-0.1.0.0-inplace"
