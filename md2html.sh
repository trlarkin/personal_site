...
do
    ...
    then
        ...
        pandoc $pwd/md/blogs/$new_name.md -o $pwd/generated/blogs/$new_name.html -f markdown+tex_math_double_backslash -T html --filter pandoc-filter/exe/pandoc-filter  --mathjax # --css ../../css/blog.css
    fi
done
